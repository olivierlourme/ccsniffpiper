ccsniffpiper
============
**CAUTION:** This fork of ccsniffpiper addresses the issue of non consistent timestamps (negative or unordered) from appearing time to time while using `ccsniffpiper.py`. An example of such timestamps is in [dum4.pcap](pcap/dum4.pcap) (4.78 KB) or below:

![Non consistent timestamps](pcap/dum4.png)
